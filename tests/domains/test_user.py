...
class TestUser:
    def test_user_factory(self):
        user = UserFactory.join_a_member('tester', 'test', 'てすたろう', is_admin=True, is_operator=False)
        assert user.id
    ...
    def test_user_factory_identifier(self):
        user_1 = UserFactory.join_a_member('user_1', 'user1', 'User', False, True)
        user_2 = UserFactory.join_a_member('user_2', 'user2', 'UUSser', True, False)
