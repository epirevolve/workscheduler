...
class TeamCommand:
    ...
    def append_team_category(self, name: str, allow_multiple_belonging: bool,
                             is_leader_required: bool, min_member_count: int, max_member_count: int):
        team_category = TeamCategoryFactory.register_a_team_category(
            name, allow_multiple_belonging, is_leader_required,
